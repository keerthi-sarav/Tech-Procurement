              ...
              {displayList.map(po=>(
                <tr key={po.po_number} className="hover:bg-[#f9fafb] transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${statusColor(po.approval_status)}`}>
                      <StatusIcon s={po.approval_status} /> {po.approval_status}
                    </span>
                  </td>
                  <td className="px-5 py-3.5">
